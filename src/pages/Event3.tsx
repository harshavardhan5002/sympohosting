    ...
    <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 space-y-16">
      ...
      <section className="relative rounded-2xl overflow-hidden">
        <div
          ...
          style={{
            backgroundImage: 'url(https://images.unsplash.com/photo-1485827404703-89b55fcc595e?ixlib=rb-1.2.1&auto=format&fit=crop&w=2000&q=80)',
        ...
        <div className="relative z-10 py-24 px-6 md:px-12">
          <motion.div>
            <h1 className="text-4xl md:text-6xl font-bold mb-10">
              ...
              Ignite the Spark, Conquer the Current!
            ...
            <Link
              to="/register"
              className="inline-flex items-center px-9 py-3 text-lg font-medium text-white bg-primary-600 rounded-full hover:bg-primary-700 transition-colors"
            >
              Register Now
        ...
        <motion.div className="space-y-6">
          ...
          <div className="grid gap-6">
            {[
              ...
              { icon: <MapPin className="h-6 w-6" />, text: "R&D Lab" },
                        ...
                        {[
                          {
                            title: "Format",
                            items: [
                              "15 Minutes for one set",
                              "Total 2 rounds",
                              "1st round - MCQs",
                              "2nd round - Rapid Fire",
                              "30secs - 1 min per Question"
                            ]
                          },
                          {
                            title: "Evaluation Criteria",
                            items: [
                              "High points qualified for 2nd round",
                              "Q&A handling",
                              "Solving Final round questions"
